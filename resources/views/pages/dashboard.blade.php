                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="#mymodal" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#mymodal" data-title="Detail Transaksi {{ $item->uuid }}" class="btn btn-info">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <!-- <a href="{{route('transactions.show',$item->id)}}" class=" btn btn-info"><i class="fa fa-pencil"></i></a> -->
                                            <a href="{{route('transactions.edit',$item->id)}}" class=" btn btn-primary"><i class="fa fa-pencil"></i></a>
